  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 inset-x-0 preserve-3d flex justify-center [transform:translateZ(80px)] pointer-events-auto">
        ...
        <div className="relative w-[95%] md:w-[90%] max-w-5xl h-40 md:h-56 rounded-t-xl bg-gradient-to-b from-[#5c3725] via-[#3a1b0d] to-[#1a0a05] border-t-8 border-[#7a432b] shadow-[0_-10px_30px_rgba(0,0,0,0.8),0_40px_80px_-10px_rgba(0,0,0,1)] p-3 md:p-5 flex items-start justify-between overflow-visible">
          ...
          <div className="flex flex-col items-center z-10 -mt-8 mx-auto">
            {/* Screen */}
            <div className={`w-40 h-28 md:w-72 md:h-48 rounded-t-xl bg-[#0a0a0a] border-4 border-[#1a1a1a] p-2 md:p-3 flex flex-col justify-start transition-all duration-1000 relative overflow-hidden ${
            ...
            {/* Keyboard Base */}
            <div className="w-48 md:w-80 h-3 md:h-4 bg-[#151515] rounded-b-lg shadow-[0_20px_40px_rgba(0,0,0,0.8)] border-t-2 border-white/10" />
          </div>
