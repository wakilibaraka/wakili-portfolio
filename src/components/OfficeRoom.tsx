...
export default function OfficeRoom() {
  ...
  // Advanced 3D Scroll Physics (Zoom through the door portal)
  ...
  return (
    <div className={`relative w-full h-[300vh] transition-colors duration-1000 ${isNightMode ? "bg-[#030604]" : "bg-[#09150f]"}`}>
      <div
      ...
      >
        ...
        <motion.div
          style={{ x: scrollRoom1X, y: scrollRoom1Y, z: scrollRoom1Z, opacity: scrollRoom1Opacity }}
        ...
        <motion.div
          style={{ z: scrollRoom2Z, opacity: scrollRoom2Opacity }}
